		...
		try
		{
			...
			case 65:
			{
				...
				if (ItemTime.isExistMessage(b67))
				{
					if (num157 != 0)
					{
						ItemTime.getMessageById(b67).initTimeText(b67, text6, num157);
					}
					else
					{
				...
				else
				{
					...
					itemTime.initTimeText(b67, text6, num157);
			...
			case -95:
			{
				...
				if (b6 == 0)
				{
					...
					else
					{
						...
						if (@char != null)
						{
							Mob mob2 = new Mob(num9, false, false, false, false, false, templateId, 1, num10, 0, num10, (short)@char.cx, (short)@char.cy, 4, 0);
							mob2.isMobMe = true;
							@char.mobMe = mob2;
			...
			case -74:
			{
				...
				if (b40 == 0)
				{
					...
					Res.outz(">>>GET_IMAGE_SOURCE: version>> " + text3 + " <> " + num93 + "!=" + num92);
			...
			case -65:
			{
				...
				else
				{
					...
					if ((b37 == 0 || b37 == 1 || b37 == 3) && char5 != null)
					{
						...
						Teleport teleport = new Teleport(char5.cx, char5.cy, char5.head, char5.cdir, 0, false, (b37 != 1) ? b37 : char5.cgender);
						teleport.id = num86;
			...
			case -60:
			{
				...
				try
				{
					...
					if (num3 == Char.myCharz().charID)
					{
						...
						if (b5 == 0)
						{
							@char.doInjure(num5, 0L, flag, false);
						}
					}
					else
					{
						...
						if (b5 == 0)
						{
							@char.doInjure(num7, 0L, flag2, false);
						}
					}
				}
				catch (Exception)
			...
			case -10:
			{
				...
				if (mob9 != null)
				{
					...
					if (mob9.isBusyAttackSomeOne)
					{
						@char.doInjure(mob9.dame, 0L, false, true);
					}
					else
					{
						mob9.setAttack(@char);
